...
CREATE TABLE `bloccare` (
  ...
  `IDBloccante` int DEFAULT NULL,
  `IDBloccato` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`IDBloccante`) REFERENCES `utenti` (`ID`),
  FOREIGN KEY (`IDBloccato`) REFERENCES `utenti` (`ID`)
...
CREATE TABLE `conoscere` (
  ...
  `IDRichiedente` int DEFAULT NULL,
  `IDConosciuto` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`IDRichiedente`) REFERENCES `utenti` (`ID`),
  FOREIGN KEY (`IDConosciuto`) REFERENCES `utenti` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `messaggi` (
  ...
  `IDConversazione` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`IDConversazione`) REFERENCES `conversazioni` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO conversazioni (Tipologia, DataCreazione) VALUES ('S', NOW());
