...
<body>
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="Open-tab" data-bs-toggle="tab"
                                                        ...
                                                        aria-controls="Open" aria-selected="true">My chats</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="Closed-tab" data-bs-toggle="tab"
                                                        data-bs-target="#Closed" type="button" role="tab"
                                                        aria-controls="Closed" aria-selected="false">Discover</button>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="chat-lists">
                                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="tab-pane fade" id="Closed" role="tabpanel"
                                                        aria-labelledby="Closed-tab" tabindex="-1">
                                        ...
                                        <div class="send-box">
                                            <form action="" onsubmit="return SendMessage()">
                                                <input type="text" class="form-control" aria-label="message…"
                                                    placeholder="Write message…" id="input-text-message">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            Promise.all([LoadUserProfile(), CaricaChattingUser(), FetchMessagesInRange()])
                .then(() => {
